...
- 明选对 drift 的注入（②献名字/③B「我不知道」）——M5e 明选引擎
...
节奏验证：9 次夺梦（菟丝子等价）drift +4.5 → 深漂档；记忆 30→100 额外 +1.4——夺梦是主漂移源，「吞噬行为 = 自我遗忘」的主题闭环成立。
...
**微漂**（3-5）：
> 影子的轮廓清晰了一些。他站在你旁边，树皮的纹理在他身上慢慢退去。

**深漂**（6-8）：
> 他的五官开始模糊。枝条从他的肩头长出来，他低头看了看，没有惊讶。

**迷失**（9-10）：
> 只剩一个人形的影子。他站在你的树影里，分不清谁是谁。你忽然想不起，他叫什么名字。
