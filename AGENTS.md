...
- M5 已封板（2026-09-05）：34 套件 / 366 测试；M6 主闭环已封板并完成首轮 Code Review 修复（2026-09-06）：**37 套件 / 436 测试**全部通过。
...
- M6 主闭环的设计决策、实现记录与已知缺口（含 reset_to_title 回标题语义、condense-good 判定），以
